...
public class SumZnExpression extends NAryExpression implements SumExpression, ArithZnElementExpression {


    private List<ArithZnElementExpression> summands;

    public SumZnExpression() {
        this.summands = new ArrayList<>();
    }

    public SumZnExpression(List<ArithZnElementExpression> summands) {
        this.summands = summands;
    }

    public SumZnExpression(Representation representation) {
