...
public class ZnElementEqualityExpression implements ZnElementComparisonExpression {

    private ArithZnElementExpression lhs;
    private ArithZnElementExpression rhs;

    public ZnElementEqualityExpression(ArithZnElementExpression lhs, ArithZnElementExpression rhs) {
        this.lhs = lhs;
        this.rhs = rhs;
    }

    public ZnElementEqualityExpression(Representation representation) {
    ...
    public void not(ArithZnElementExpression lhs) {
        this.lhs = lhs;
    }
    ...
    public boolean equals(Object o) {
        ...
        ZnElementEqualityExpression that = (ZnElementEqualityExpression) o;
