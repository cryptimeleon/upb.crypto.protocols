...
public class GroupElementEqualityExpression implements GroupElementComparisonExpression {

    private ArithGroupElementExpression lhs;
    private ArithGroupElementExpression rhs;

    public GroupElementEqualityExpression(ArithGroupElementExpression lhs, ArithGroupElementExpression rhs) {
        this.lhs = lhs;
        this.rhs = rhs;
    }

    public GroupElementEqualityExpression(Representation representation) {
    ...
    public EquationPrimitives getComparator() {
        return EquationPrimitives.EQUAL;
    }
    ...
    @Override
    public ArithGroupElementExpression getRHS() {
        return rhs;
    }
    ...
    public boolean equals(Object o) {
        ...
        GroupElementEqualityExpression that = (GroupElementEqualityExpression) o;
